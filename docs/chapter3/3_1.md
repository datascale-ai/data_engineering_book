...
![图6-1：图片预处理中裁剪与语义对齐问题](../images/chapter3/6_1_图片预处理中裁剪与语义对齐问题.png)
...
![图6-2：使用DALI与不使用DALI下数据解码与变换的区别](../images/chapter3/6_2_使用DALI与不使用DALI下数据解码与变换的区别.png)
...
![图6-3：Ray Data分布式清洗数据流向图](../images/chapter3/6_3_Ray_Data_分布式清洗数据流向图.png)
