...
<figure>
  <img src="../images/第3章/7_2_2.png" alt="图表描述：左侧为简略Prompt及其输出示例，右侧为详细Prompt及其输出示例，清晰展示了不同Prompt策略下描述颗粒度的差异，包括描述长度、细节丰富度、场景覆盖范围等">
...
<figure>
  <img src="../images/第3章/7_3.png" alt="图表描述：OCR增强VLM重描述的完整流水线，从原始富文本图像输入，到OCR提取文字（含置信度），再到文字上下文构建，最后到Prompt融合并输入VLM生成重描述，清晰展示了各环节的衔接关系和数据流向">
