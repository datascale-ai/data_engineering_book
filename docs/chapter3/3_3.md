...
### 8_1 视频处理流水线：场景切分 (Scene Detection)
...
![图 8-1：视频场景切分的两种策略与HSV直方图差异](../images/chapter3/8_1_视频场景切分的两种策略与HSV直方图差异.png)
...
### 8_2 视频 Tokenization：从像素海洋到离散岛屿
...
### 8_3 音频对齐：WhisperX 与强制对齐 (Forced Alignment)
...
![图 8-2：普通 ASR (Segment-level) 与 WhisperX (Word/Phoneme-level) 的精度对比](../images/chapter3/8_2_ASR与WhisperX的精度对比.png)
*图 8-2：普通 ASR (Segment-level) 与 WhisperX (Word/Phoneme-level) 的精度对比*

#### 8_3.1 为什么需要 Forced Alignment？
* **ASR (OpenAI Whisper)**：
