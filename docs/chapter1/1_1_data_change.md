...
## 1_1 Scaling Laws 的启示：从"大数据"到"高质量数据"的范式转移

### 1_1.1 什么是 Scaling Laws？
...
![图1-1：数据质量对比图](../images/chapter1/图1_1_数据质量对比.png)
...
### 1_2.1 四阶段范式：Pre-train → SFT → RLHF → RAG

![图1-2：LLM数据生命周期](../images/chapter1/图1_2_LLM数据生命周期.png)
...
![图1-3：数据漏斗模型](../images/chapter1/图1_3_数据漏斗模型.png)
...
![图1-4：多模态处理复杂度](../images/chapter1/图1_4_多模态处理复杂度.png)
...
![图1-5：数据质量与训练效率](../images/chapter1/图1_5_数据质量与训练效率.png)
...
![图1-6：知识结构思维导图](../images/chapter1/图1_6_知识结构思维导图.png)
