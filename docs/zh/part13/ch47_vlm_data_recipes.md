...
以下是一个 Qwen2.5-VL 风格自蒸馏 Caption 重写管线的核心代码框架（详细可执行版本位于 [`code/zh/project_13_mm_instruction_factory/generate_with_qwen_vl.py`](../../../code/zh/project_13_mm_instruction_factory/generate_with_qwen_vl.py)）：
