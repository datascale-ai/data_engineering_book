...
![图47-2：VLM 数据三阶段流水线 (3-Stage VLM Data Engineering Pipeline)](../../images/part13/ch47_02_vlm_three_stages_en.png)
...
![图47-3：Native vs Dynamic Resolution 数据 pipeline 对比 (Resolution Handling)](../../images/part13/ch47_03_resolution_handling_en.png)
...
![图47-4：多模态指令合成 pipeline (Multi-modal Instruction Synthesis)](../../images/part13/ch47_04_instruction_synthesis_en.png)
