...
下面以“信息抽取 + JSON约束输出”为例，展示一条可直接用于SFT的数据样式。注意：示例的重点不在“答案写得漂亮”，关键是把**任务边界、缺失值策略、字段约束**写清楚。
...
![图12-1：SFT指令体系的架构示意图](../../images/part4/图12_1_zh.png)
...
![图12-2：样本生成与验收的闭环示意图](../../images/part4/图12_2_zh.png)
