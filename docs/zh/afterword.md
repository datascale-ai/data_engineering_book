...
如果你处在教学、实验室协作、开源基准或跨团队共建环境中，则最应连读第八篇、第九篇、第十二篇与附录 A-F，因为真正困扰这些场景的往往不是单点算法，而是治理、复现、职责边界与长期运维。
...
第十二篇和附录 A-F 则更进一步，把前面已经出现的工作对象重新组织成“可发布、可评测、可教学、可维护”的长期资产，回答的是“怎样让一套数据工作不只完成一次任务，而能长期被团队和社区继续使用”。
