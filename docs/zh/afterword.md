...
从零搭建大模型数据基础设施的读者，更适合先阅读第一篇和第八篇，建立关于数据生命周期、平台分层、版本治理和实验追踪的整体框架，再回到第二篇、第三篇和后续专题章节补齐具体流程细节。
正在做预训练、指令微调或偏好对齐的读者，更适合从第二篇、第四篇和第五篇切入，再结合第十三篇的开源配方与第十四篇的项目实战理解不同任务之间的共性与差异。
面向多模态、RAG、Agent 或复杂应用场景的读者，通常更适合优先阅读第三篇、第六篇、第七篇和第十二篇，因为这些部分更强调证据组织、轨迹数据、专项数据集构建和可复查评测。
处在教学、实验室协作、开源基准或跨团队共建环境中的读者，则更适合连读第八篇、第九篇、第十二篇与附录 A-C，因为真正困扰这些场景的往往不是单点算法，而是治理、复现、职责边界与长期运维。
