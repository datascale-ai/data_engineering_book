...
![图1-1：大模型时代数据工程职责重构图，展示平台、数据、算法、标注、产品与合规角色之间的闭环接口](../../images/part1/Yu-Chap01-Fig01.svg)
...
![图1-2：全书十四篇制生命周期地图，展示从总论、预训练、多模态、对齐、应用、平台、合规到项目实战的知识结构](../../images/part1/Yu-Chap01-Fig02.svg)
