...
![图2-2：大模型数据缺陷与质量指标交叉映射图](../../images/part1/defect_metric_radar_1775835533937.png)

*图2-2：大模型数据缺陷与质量指标交叉映射图 —— 展示六大核心缺陷类型（噪声、重复、基准污染、系统偏差、结构缺失、时效衰败）与五大核心质量指标（准确度、一致性、多样性、覆盖度、可追溯性）之间的影响关系网络。*
...
5. **可追溯性 (Traceability)**：出现错误时，能否顺着血缘将脏数据溯源定位到某个网页或原始桶（严重影响排错效率）。
