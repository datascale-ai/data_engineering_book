...
### 36.4.1 Agent Judge 与人工 Judge 的校准机制
...
## 36.5 案例复盘：对话模型标注评测体系的 Agent 化改造
...
## 36.6 Checklist：标注合成评测 Agent 部署自查
