...
本书面向大模型时代的数据工程问题，讨论数据从原始材料进入训练、评测、应用、平台治理和长期资产沉淀的完整过程。全书以中文主线为准，当前出版结构冻结为 **14 篇、48 章、15 个项目、6 个附录**；英文与日文版本作为后续翻译、术语对照和对外传播材料，不作为本次交付的完整出版稿。
...
附录 A-F 提供工具、合规、成本、工程化转换、调试和术语模板，服务于出版交付、课程复现和团队项目管理。
