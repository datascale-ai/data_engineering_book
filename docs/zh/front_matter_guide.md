...
本书面向大模型时代的数据工程问题，讨论数据从原始材料进入训练、评测、应用、平台治理和长期资产沉淀的完整过程。全书以中文主线为权威源版本，当前出版结构冻结为 **14 篇、48 章、15 个项目、7 个附录（A–G）**；英文书稿作为翻译稿和对外提交预览稿维护，最终交付前仍需复核术语、贡献者元数据和出版社管理的元数据。
