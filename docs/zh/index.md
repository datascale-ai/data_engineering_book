...
本书当前中文主线采用 2026 版结构，正文覆盖 33 章与 14 个端到端项目。为降低跨篇阅读门槛，本版在前置部分新增统一的缩写表，并为每一篇补充了分册目录与分册索引词页。
...
- [第九篇：隐私合规与数据安全](part9/index.md)
- [第十篇：项目实战](part10/index.md)
- [第十一篇：开源大模型数据工程实战](part11/index.md)
...
- [第十篇索引词](part10/index_terms.md)

## 第十一篇：开源大模型数据工程实战

- [本篇目录](part11/index.md)
- [第29章：LLM 预训练数据配方](part11/ch29_pretrain_recipes.md)
...
- [项目十三：多模态指令工厂](part11/projects/p13_multimodel_ins.md)
- [项目十四：视频生成数据集——从视频源到可用于 T2V 训练的数据流水线](part11/projects/p14_vedio_gen.md)
- [第十一篇索引词](part11/index_terms.md)
