...
### Latent-Switch.1：开篇问题场景：Long-CoT 为什么还需要被压缩
...
### Latent-Switch.2：数据集概览：规模、难度与领域构成
...
![图43-2：Latent-Switch-69K 数据来源与领域组成](../../images/part12/ch40_05_dataset_composition.png)
...
### Latent-Switch.3：蒸馏与记录形成：从 teacher trace 到压缩推理记录
...
![图43-4：原始与蒸馏后推理长度及压缩率统计](../../images/part12/ch40_07_token_compression_distribution.png)
...
### Latent-Switch.4：Latent budget 与 student sequence：样本如何被渲染
...
### Latent-Switch.5：Supervision masks：哪些 token 参与 loss
...
### Latent-Switch.6：质量控制：压缩、边界与偏置的五类风险
...
### Latent-Switch.7：与前后章节的回链：从推理数据到推理飞轮
...
### Latent-Switch.8：复用建议：把 Latent-Switch 思路迁移到自有数据
