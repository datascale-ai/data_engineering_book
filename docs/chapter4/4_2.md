...
## 10_1 核心概念与原理 (Concepts & Principles)
...
### 10_1.2 教科书级数据 (Textbooks Are All You Need)
...
![图 10-1： Phi-1流程示意图](../images/chapter4/10_1_Phi-1流程示意图.png)
*图 10-1： Phi-1流程示意图*

### 10_1.3 代码与数学合成：PoT (Program of Thought)
...
## 10_2 工程实现 (Engineering Implementation)

本节我们将深入代码层面，构建一套完整的数据合成流水线。我们将重点关注如何保证数据的多样性，防止生成的“教科书”千篇一律。

### 10_2.1 教科书级数据：分类器与合成流水线
...
### 10_2.2 逆向翻译 (Back-Translation)：从答案反推问题
...
### 10_2.3 代码与数学合成：PoT (Program of Thought)
...
### 10_2.4 多模态指令合成：LLaVA Pipeline

利用纯文本模型合成多模态数据是 LLaVA 的创举。这种方法的核心在于将视觉信息**“符号化” (Symbolization)**——既然纯文本模型（如 GPT-4）看不见图像，我们就把图像翻译成它能读懂的“代码”。



![图 10-2： LLaVA 数据合成流程示意图](../images/chapter4/10_2_LLaVA数据合成流程示意图.png)
*图 10-2： LLaVA 数据合成流程示意图*
...
![图 10-3： 多专家混合流水线示意图](../images/chapter4/10_3_多专家混合流水线示意图.png)
*图 10-3： 多专家混合流水线示意图*
...
## 10_3. 性能与评估 (Performance & Evaluation)
...
## 10_4. 避坑指南 (Pitfalls & Troubleshooting)
