...
![Figure 21-1: Data transformation pipeline in a RAG system](../../images/part7/Du-Chap21-Fig01-EN.svg)
...
The core goal of RAG data ingestion is therefore not the physical movement of data, but the construction of a stable, traceable, and updatable structured data stream. Only with strict ingestion specifications can the subsequent parsing, cleaning, and indexing have a solid engineering foundation.
...
![Figure 21-9: Evaluation, feedback, and optimization loop in a RAG system](../../images/part7/Du-Chap21-Fig09-EN.svg)
