...
From a data-engineering perspective, logs should not be viewed merely as operational data; they are also an important source of failure samples, recovery samples, and safety samples. An agent system without structured logs, even after accumulating large volumes of online interactions, will find it very hard to convert those interactions into trainable data assets.
